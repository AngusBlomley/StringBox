      ...
      <nav>
        ...
        <section class="breadcrumbs_Cart">
            <div class="breadcrumbs">
                ...
                <a style="color:dodgerblue" href="browse.php">/ Browse</a>
                <a>/ Products</a>
            </div>
        </section>
        <main>
            ...
            <section class="grid">
                ...
                <div class="grid-item">
                    <img src="Photos/product_photos/babolat_rpm_blast.jpg">
                    <p>Babolat RPM Blast. Co-polyester string known for its high-powered and controlled shots. It has a unique octagonal shape and textured surface for increased spin and durability. Excellent combination of power, control, and spin.</p>
                    <br>
