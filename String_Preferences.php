...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/String_Prefernces.css" />
    ...
    <div id="header">
      ...
      <nav>
        ...
        <div class="breadcrumbs">
            <a style="color:dodgerblue" href="index.php">Home </a><a style="color:dodgerblue" href="shop.php">/ Customise</a><a> / String Prefrence</a>
        </div>

        <section class="main">
            <img src="Photos/chino-rocha-q9dswAd5Pc0-unsplash.jpg">
            <article>
                <div>
                    <h1>String Preferences</h1>
                    <p>Fixed restring price of </p>
                    <p style="color:red"> £35 </p>
                    <p style="text-decoration: line-through;font-size: 0.8em;color:grey;font-weight: 300;"> £50 </p>
                </div>
                <form>
                    <!-- Tension drop-down -->
                    ...
                    <!-- String crossing drop-down -->
                    <label for="crossing">String crossing:</label>
                    ...
                    <textarea id="message" name="message" placeholder="Special requests, messages, notes." rows="5" cols="30"></textarea>
                    <br>
